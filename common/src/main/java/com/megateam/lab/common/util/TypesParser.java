...
public class TypesParser {
	public static Integer parseInteger(String line) throws InaproppriateArgumentsTypeException {
		...
		{
			throw new InaproppriateArgumentsTypeException("Inaproppriate argument type: should be integer.");
		}
	}
	...
	public static Boolean parseBoolean(String line) throws InaproppriateArgumentsTypeException {
		...
		throw new InaproppriateArgumentsTypeException("Inaproppriate argument type: should be boolean.");
	}
	...
	public static Float parseFloat(String line) throws InaproppriateArgumentsTypeException {
		try {
			...
			throw new InaproppriateArgumentsTypeException("Inaproppriate argument type: should be float.");
		}
	}
